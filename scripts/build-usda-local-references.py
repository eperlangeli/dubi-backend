...
QUERY_MAP = {
    ...
    "noodles di riso": "rice noodles dry",
    "olio evo": "oil olive salad or cooking",
    "olive": "olives ripe canned",
    "orzo perlato": "barley pearled dry",
    ...
    "riso": "rice brown long-grain raw",
    "riso basmati": "rice white long-grain raw",
    "riso jasmine": "rice white long-grain raw",
    "riso nero": "rice brown long-grain raw",
...
PREFERRED_CONTAINS = {
    ...
    "orzo perlato": ["barley, pearled, raw"],
    "pasta di lenticchie": ["lentils, raw"],
}
